...
@snap[midpoint span-65 text-05]<div style="margin-left: -150px">
...
<div style="margin-top: 25px; margin-right: 50px;">@img[fragment](ln.png)</div>
@snapend
...
<div style="margin-top: 25px; margin-right: 50px;">@img[fragment](0.5.png)
@snapend
