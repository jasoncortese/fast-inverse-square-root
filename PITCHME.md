...
@snap[south span-85 text-05 text-black]
<div style="margin-bottom: 100px; text-align: center;">Look familiar yet?</div>
@snapend
...
@snap[north span-85 text-05 text-black]
<div style="margin-top: 100px; text-align: left;">How about now? </div>
@snapend

@snap[south span-85 text-05 text-black]
<div style="margin-bottom: 100px; text-align: center;">We're looking for a constant K that we can subtract one half of the integer from to approximate the square root. Choosing an appropriate sigma (0.0450465) yields our magic number.</div>
@snapend
